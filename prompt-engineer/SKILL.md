...
description: "Writes, refactors, and evaluates LLM prompts: templates, structured-output schemas, personas and guardrails, eval rubrics and test suites. Use when designing or improving prompts for accuracy or token efficiency."
license: MIT
metadata:
