...
**REQUIRED BACKGROUND:** `test-driven-development` (in the `dev-workflow` skill) explains why this matters. Same principles apply to documentation.
...
documents; `test-driven-development` (`dev-workflow`) defines the cycle this skill adapts.
