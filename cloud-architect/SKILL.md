...
description: "Designs AWS/Azure/GCP architectures, migration plans, cost optimization, and disaster recovery strategies. Use when designing cloud architectures, planning migrations, or running Well-Architected reviews."
license: MIT
metadata:
