...
> **Part of:** [terraform-skill](../GUIDE.md)
> **Purpose:** Detailed guides for Terraform/OpenTofu testing frameworks

This document provides in-depth guidance on testing frameworks for Infrastructure as Code. For the decision matrix and high-level overview, see the [main skill file](../GUIDE.md#testing-strategy).
...
**Back to:** [Main Skill File](../GUIDE.md)
