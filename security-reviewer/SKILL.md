...
description: "Security audits with structured severity-rated reports and remediation guidance. Use when reviewing code or infrastructure for vulnerabilities, SAST, dependency/secrets scanning, pentest prep, or compliance checks."
license: MIT
...
2. **Scan**: Run SAST, dependency, and secrets tools. Example commands:
   ...
   - `trivy fs .`
3. **Review**: Manual review of auth, input handling, and crypto. Tools miss context, so manual review is mandatory.
