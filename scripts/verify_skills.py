#!/usr/bin/env python3
"""Verify every skill in this repository.

Checks, per top-level directory (excluding schema/, scripts/, .github/):
  - a SKILL.md exists
...
Exit code 0 only when every skill passes. Run locally and in CI:
...
EXCLUDED_DIRS = {"schema", "scripts", ".github"}
